...
import { pieceValue } from "./Engine";
import { getAttackedPiece } from "./Engine";
...
export class State {
    ...
    addStateScoreBias(game: Chess,  move: Move, player: string): number {
      ...
      if(move.captured) 
        score += move.color == player ? (pieceValue[move.captured] / pieceValue['q']) : -(pieceValue[move.captured] / pieceValue['q']);
